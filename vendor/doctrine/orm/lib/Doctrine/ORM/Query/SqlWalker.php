...
class SqlWalker implements TreeWalker
{
    ...
    private function generateRangeVariableDeclarationSQL(
        ...
        $sql = $this->platform->appendLockHint(
            $this->quoteStrategy->getTableName($class, $this->platform) . ' SqlWalker.php' .
            $this->getSQLTableAlias($class->getTableName(), $dqlAlias),
    ...
    public function walkCollectionMemberExpression($collMemberExpr)
    {
        ...
        if ($assoc['type'] === ClassMetadata::ONE_TO_MANY) {
            ...
            $sql .= $this->quoteStrategy->getTableName($targetClass, $this->platform) . ' SqlWalker.php' . $targetTableAlias . ' WHERE ';
            ...
            $sql .= $this->quoteStrategy->getJoinTableName($owningAssoc, $targetClass, $this->platform) . ' SqlWalker.php' . $joinTableAlias . ' WHERE ';
