...
class SizeFunction extends FunctionNode
{
    ...
    public function getSql(SqlWalker $sqlWalker)
    {
        ...
        if ($assoc['type'] === ClassMetadata::ONE_TO_MANY) {
            ...
            $sql .= $quoteStrategy->getTableName($targetClass, $platform) . ' SizeFunction.php' . $targetTableAlias . ' WHERE ';
            ...
            $sql .= $quoteStrategy->getJoinTableName($owningAssoc, $targetClass, $platform) . ' SizeFunction.php' . $joinTableAlias . ' WHERE ';
